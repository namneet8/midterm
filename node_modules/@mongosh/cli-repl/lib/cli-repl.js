...
class CliRepl {
    ...
    async setupAnalytics() {
        ...
        this.toggleableAnalytics = new logging_1.ToggleableAnalytics(new logging_1.ThrottledAnalytics({
    ...
    verifyPlatformSupport() {
        ...
        const processReport = (_a = process.report) === null || _a === void 0 ? void 0 : _a.getReport();
        if (!processReport) {
            return;
        }
        const warnings = [];
        ...
        if (processReport.header.glibcVersionRuntime !== undefined &&
