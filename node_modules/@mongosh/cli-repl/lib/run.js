    ...
    try {
        ...
        if (options.smokeTests) {
            ...
            if (process.execPath === process.argv[1]) {
                await (0, smoke_tests_1.runSmokeTests)(smokeTestServer, process.execPath, ...cryptLibraryOpts);
            }
            else {
                await (0, smoke_tests_1.runSmokeTests)(smokeTestServer, process.execPath, process.argv[1], ...cryptLibraryOpts);
            }
            return;
        }
        if (process.execPath === process.argv[1]) {
